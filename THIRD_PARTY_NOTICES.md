...
NVIDIA Audio Effects SDK is used only when separately installed by the user. Future SDK integration must discover a user-provided SDK installation and must not hardcode local NVIDIA SDK paths.
